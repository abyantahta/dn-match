...
<body>
    {{-- <h1>haloo</h1> --}}
    <x-navbar-component>DN ADM KAP</x-navbar-component>


    <div class="container px-0 mt-2 ">
        <div class=" w-full  ">
            <h3 class="card-header p-3 text-3xl"><i class="fa fa-star"></i> DN ADM KAP</h3>
            <div class="card-body">
                ...
                <form action="{{ route('dn.adm.kap.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex gap-4">
                        ...
                        <a class="btn btn-warning font-bold flex gap-2 items-center justify-center" href="{{ url('export/transactions/kap') }}"><i class="fa fa-file"></i>Export Last 2 Days Transaction</a>
                    </div>
